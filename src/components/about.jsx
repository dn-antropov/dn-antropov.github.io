...
const About = () => {
    ...
    <>
      ...
      <div >
        <p>
          I'm a creative developer and a technical artist. I find inspiration in
          the constantly evolving world of technology, always exploring new ways to communicate
          ideas and narratives — both my own and those of the people I work with or work for.
          It's no surprise that surviving solely on art projects is no joke, but I still try to do my small artsy bits.
          They help me stay sharp and feed back into the commercial commissions that keep me going.
        </p>
        <p>
          Interesting fact about me. I didn't receive professional training in computer science or art.
